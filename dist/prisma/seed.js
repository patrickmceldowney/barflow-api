    ...
    const flavorProfiles = await Promise.all([
        prisma.flavorProfile.upsert({
            ...
            create: {
                name: 'Sweet',
                slug: 'sweet',
                description: 'Sugary taste, often from syrups, liqueurs or fruit juices',
            },
        }),
        prisma.flavorProfile.upsert({
            where: { slug: 'sour' },
        ...
        prisma.flavorProfile.upsert({
            ...
            create: {
                name: 'Bitter',
                slug: 'bitter',
                description: 'Sharp, sometimes unpleasant taste, often from ingredients like bitters or certain herbs',
            },
        }),
        prisma.flavorProfile.upsert({
            where: { slug: 'herbal' },
            ...
            create: {
                name: 'Herbal',
                slug: 'herbal',
                description: 'Plant-like taste, often from herbs like mint, basil, or rosemary',
            },
        }),
        prisma.flavorProfile.upsert({
            where: { slug: 'fruity' },
            ...
            create: {
                name: 'Fruity',
                slug: 'fruity',
                description: 'Taste reminiscent of fruits, often from fruit juices or fruit-flavored liqueurs',
            },
        }),
    ]);
    ...
    const ingredients = await Promise.all([
        ...
        prisma.ingredient.upsert({
            ...
            create: {
                ...
                slug: 'simple-syrup',
                type: 'syrup',
                description: 'Equal parts sugar and water, heated until sugar dissolves',
            },
        }),
        prisma.ingredient.upsert({
    ...
    await Promise.all([
        ...
        prisma.recipeStep.upsert({
            ...
            create: {
                cocktailId: mojito.id,
                stepNumber: 1,
                instruction: 'Muddle mint leaves with sugar and lime juice in a collins glass',
            },
        }),
        prisma.recipeStep.upsert({
            where: {
